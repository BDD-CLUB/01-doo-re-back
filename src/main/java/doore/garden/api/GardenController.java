...
public class GardenController {
    ...
    @GetMapping("/{teamId}")
    public ResponseEntity<List<DayGardenResponse>> getFullGarden(@PathVariable Long teamId) {
        List<DayGardenResponse> fullGardenResponse = gardenQueryService.getFullGarden(teamId);
