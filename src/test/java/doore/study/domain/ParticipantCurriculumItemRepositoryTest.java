...
public class ParticipantCurriculumItemRepositoryTest extends RepositorySliceTest {
    ...
    public void findAllByStudyIdAndMemberId_스터디_id와_회원_id를_사용해_participantCurriculumItem_목록을_조회할_수_있다_성공()
        ...
        Study otherStudy = StudyFixture.algorithmStudy();
        ...
        CurriculumItem curriculumItem = CurriculumItem.builder()
                ...
                .study(study)
                .build();
        CurriculumItem otherStudyCurriculumItem = CurriculumItem.builder()
                .itemOrder(1)
                .name("다른 스터디의 커리큘럼 1")
                .study(otherStudy)
                .build();
        ...
        ParticipantCurriculumItem participantCurriculumItem = ParticipantCurriculumItem.builder()
                ...
                .build();
        ParticipantCurriculumItem otherParticipantCurriculumItem = ParticipantCurriculumItem.builder()
                .participantId(otherParticipant.getId())
                .curriculumItem(curriculumItem)
                .build();
        ParticipantCurriculumItem otherStudyParticipantCurriculumItem = ParticipantCurriculumItem.builder()
                .participantId(participantFromOtherStudy.getId())
                .curriculumItem(otherStudyCurriculumItem)
                .build();
        ...
        Assertions.assertThat(participantCurriculumItems.get(0).getCurriculumItem().getStudy().getId()).isEqualTo(study.getId());
    }
}
