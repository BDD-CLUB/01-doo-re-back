...
NOTE: 유효기간이 1일인 초대 링크가 생성됩니다.
이미 생성된 초대 링크가 있다면, 초대 링크를 반환합니다.

.HTTP Request
include::{snippets}/team-create-invite-link/http-request.adoc[]

.Path Parameters
include::{snippets}/team-create-invite-link/path-parameters.adoc[]

.Request Body's Fields
include::{snippets}/team-create-invite-link/request-fields.adoc[]

.HTTP Response
include::{snippets}/team-create-invite-link/http-response.adoc[]

.Response Body's Fields
include::{snippets}/team-create-invite-link/response-fields.adoc[]
