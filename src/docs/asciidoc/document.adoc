...
.Query Parameters
include::{snippets}/document-get-list/query-parameters.adoc[]
...
== `GET`: Document 조회
.Http Request
include::{snippets}/document-member-get-list/http-request.adoc[]

.Path Parameters
include::{snippets}/document-member-get-list/path-parameters.adoc[]

.Http Response
include::{snippets}/document-member-get-list/http-response.adoc[]
