...
.HTTP Request
include::{snippets}/study-get-entire/http-request.adoc[]

.Path Parameters
include::{snippets}/study-get-entire/path-parameters.adoc[]

.HTTP Response
include::{snippets}/study-get-entire/http-response.adoc[]
