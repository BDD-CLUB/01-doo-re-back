...
.HTTP Request
include::{snippets}/myPage-studies-get-list/http-request.adoc[]

.Path Parameters
include::{snippets}/myPage-studies-get-list/path-parameters.adoc[]

.HTTP Response
include::{snippets}/myPage-studies-get-list/http-response.adoc[]

.Response Body's Fields
include::{snippets}/myPage-studies-get-list/response-body.adoc[]
